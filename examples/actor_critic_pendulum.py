...
class ActorCritic:
    ...
    def create_actor_model(self):
        ...
        h1 = Dense(24, activation=self.ack)(state_input)
        h2 = Dense(48, activation=self.ack)(h1)
        h3 = Dense(24, activation=self.ack)(h2)
    ...
    def create_critic_model(self):
        state_input = Input(shape=self.env.observation_space.shape)
        state_h1 = Dense(24, activation=self.ack)(state_input)
        ...
        merged_h1 = Dense(24, activation=self.ack)(merged)
...
def main():
    ...
    signal.signal(signal.SIGINT, signal_handler) # ctrl-c catcher
    ...
    while True:  # make an animation
        ...
        print_state(cur_state, action, reward)
