...
class CEMOptimizer:
  ...
  def __init__(self, weights_dim, batch_size=1000, deviation=10,
                 deviation_lim=100, rho=0.1, eta=0.1, mean=None):
    self.rho = rho
    self.eta = eta
...
def train():
  ...
  opt = CEMOptimizer(3*3+3*3+3*1+3*1+3*1+1, 500,
                       rho=0.01, eta=0.3, deviation=10, deviation_lim=20)
